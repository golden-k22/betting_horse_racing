...
class TAB:
    ...
    def bet_bonus(self, date_str, meeting, venue, RaceType, RaceNo, runner_no, bonus_stake, is_fixed_bet):
        ...
        for item in bonus_select_btns:
            ...
            if text.__contains__("${0}".format(bonus_stake)):
                ...
                print("There is not available bonus bets of {0}".format(bonus_stake))
    ...
    def get_bonus_cnt(self):
        ...
        try:
            ...
            bonus_select_btns = self.browser.find_elements(by=By.XPATH, value='//h2[@data-testid="bonus-bet-card-title"]')
            all_availables = 0
            bets_50 = 0
            bets_25 = 0
            bets_125 = 0
...
if __name__ == "__main__":
    ...
    print("{0}, {1}, {2}, {3}, {4}".format(all, bet50, bet25, bet125, bet10))
    # tab_browser.place_bonus_bet("2022-06-06", "CANBERRA", "CNB", "H", 6, 4, 1, "2")
