...
def place_order(event_name, market_name, runner_no, size, price):
    result = False
    ...
    if runners_df.empty:
        ...
        print("instruction filters :", loaded_r)
        # Place the order
        print("market Id is : ", market_id)
        ...
        print("order result: ", order.__dict__)
...
if __name__ == '__main__':
    ...
    # place_order("CANBERRA", "R7 1770m", 2, 10, 10)
